...
export const metadata: Metadata = {
  ...
  description:
    "Build Kill Chain, Diamond Model, Unified Kill Chain, Attack Tree, OODA Loop, F3EAD, Bow-Tie, or hybrid intrusion and risk analysis diagrams, and export them as SVG, PNG, or JPEG.",
  openGraph: {
    title: "CTI Diagram Builder | 0xHabib",
    description:
      "Build Kill Chain, Diamond Model, Unified Kill Chain, Attack Tree, OODA Loop, F3EAD, Bow-Tie, or hybrid intrusion and risk analysis diagrams, and export them as SVG, PNG, or JPEG.",
    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-lg">
          Build Kill Chain, Diamond Model, Unified Kill Chain, Attack Tree, OODA Loop, F3EAD, Bow-Tie, or hybrid
          intrusion and risk analysis diagrams. Drag nodes, connect them, edit labels, and export to SVG, PNG, or
