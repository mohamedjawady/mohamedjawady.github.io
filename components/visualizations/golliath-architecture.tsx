    ...
    const services: Record<string, Service> = {
        ...
        opensearch: {
            ...
            details: [
                ...
                "Real-time domain and watchlist matching",
        ...
        minio: {
            ...
            details: [
                ...
                "Also accepts analyst-submitted files (e.g. forum-sourced dumps), not just scraper output",
