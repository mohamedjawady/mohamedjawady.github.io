...
<Term concept="cti">Cyber Threat Intelligence (CTI)</Term> is the output of a structured analytical process that turns raw security data into decision support. The key property is actionability. If a finding does not help a specific stakeholder make a better decision under uncertainty, it is data, not intelligence.
